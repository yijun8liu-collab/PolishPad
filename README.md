...
5. The **中/EN switch** (top right): EN mode outputs English (using a native English system prompt) and switches the UI language too; the choice is remembered, and refine-in-place mode follows it
